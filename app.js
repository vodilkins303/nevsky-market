// app.js v8 — vlvc.ru lite endpoint + skeleton loading
var API_PRODUCTS="https://vlvc.ru/api/v1/products/lite";
...
async function fetchProducts(){var ck="alko_lite";var cached=gc(ck);if(cached)return cached;
